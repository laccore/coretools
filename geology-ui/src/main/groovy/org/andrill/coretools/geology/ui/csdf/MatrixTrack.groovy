...
import org.andrill.coretools.geology.models.csdf.Matrix

class MatrixTrack extends AbstractFeatureTrack implements FeedbackProvider {
	private static final String DEFAULT_TITLE = "Matrix"
	...
	def getFilter() { return { it instanceof Matrix } }
	List<Class> getCreatedClasses() { return [Matrix] }
	protected SceneEventHandler createHandler() { 
		new DefaultTrackEventHandler(this, [new CreatePolicy(Matrix.class, [:], -1, this), new ResizePolicy(), new MovePolicy()])
	}
