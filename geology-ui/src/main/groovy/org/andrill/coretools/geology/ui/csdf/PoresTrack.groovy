...
import org.andrill.coretools.geology.models.csdf.Pores

class PoresTrack extends AbstractFeatureTrack implements FeedbackProvider {
	private static final String DEFAULT_TITLE = "Pores"
	...
	def getFilter() { return { it instanceof Pores } }
	List<Class> getCreatedClasses() { return [Pores] }
	protected SceneEventHandler createHandler() { 
		new DefaultTrackEventHandler(this, [new CreatePolicy(Pores.class, [:], -1, this), new ResizePolicy(), new MovePolicy()])
	}
