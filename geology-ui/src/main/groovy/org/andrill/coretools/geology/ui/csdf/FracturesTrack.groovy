...
import org.andrill.coretools.geology.models.csdf.Fractures

class FracturesTrack extends AbstractFeatureTrack implements FeedbackProvider {
	private static final String DEFAULT_TITLE = "Fractures"
	...
	def getFilter() { return { it instanceof Fractures } }
	List<Class> getCreatedClasses() { return [Fractures] }
	protected SceneEventHandler createHandler() { 
		new DefaultTrackEventHandler(this, [new CreatePolicy(Fractures.class, [:], -1, this), new ResizePolicy(), new MovePolicy()])
	}
