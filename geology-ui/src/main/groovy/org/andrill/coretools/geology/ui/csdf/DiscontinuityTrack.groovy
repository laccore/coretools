...
class DiscontinuityTrack extends AbstractFeatureTrack {
	...
	protected SceneEventHandler createHandler() { 
		new DefaultTrackEventHandler(this, [new CreatePolicy(Discontinuity.class, [:], getSymbolSize()), new ResizePolicy(), new MovePolicy()])
	}
}