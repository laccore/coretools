...
class MatrixTrack extends AbstractFeatureTrack {
	...
	protected SceneEventHandler createHandler() { 
		new DefaultTrackEventHandler(this, [new CreatePolicy(Matrix.class, [:], getSymbolSize()), new ResizePolicy(), new MovePolicy()])
	}
}