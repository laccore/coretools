...
class PoresTrack extends AbstractFeatureTrack {
	...
	protected SceneEventHandler createHandler() { 
		new DefaultTrackEventHandler(this, [new CreatePolicy(Pores.class, [:], getSymbolSize()), new ResizePolicy(), new MovePolicy()])
	}
}