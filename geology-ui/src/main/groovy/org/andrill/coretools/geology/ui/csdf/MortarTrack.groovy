...
class MortarTrack extends AbstractFeatureTrack {
	...
	protected SceneEventHandler createHandler() { 
		new DefaultTrackEventHandler(this, [new CreatePolicy(Mortar.class, [:], getSymbolSize()), new ResizePolicy(), new MovePolicy()])
	}
}