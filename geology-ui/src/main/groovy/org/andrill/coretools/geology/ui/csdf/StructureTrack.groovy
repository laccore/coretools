...
import org.andrill.coretools.geology.models.csdf.StructureInterval
...
class StructureTrack extends AbstractIntervalTrack {
	private static final String DEFAULT_TITLE = "Structure"
	private static final PARAMETERS = [
		...
		"symbol-size" : new TrackParameter("symbol-size", "Symbol size", "<html>Size, in pixels, of structure symbols. Applies only when Tile symbols is <b>disabled</b>.</html>", TrackParameter.Type.INTEGER, "32"),
	...
	def getFilter() { return { it instanceof StructureInterval } }
	List<Class> getCreatedClasses() { return [StructureInterval] }
	...
	protected SceneEventHandler createHandler() {
		new DefaultTrackEventHandler(this, [new CreatePolicy(StructureInterval.class, [:]), new ResizePolicy()])
	}
