...
class FracturesTrack extends AbstractFeatureTrack {
	...
	protected SceneEventHandler createHandler() { 
		new DefaultTrackEventHandler(this, [new CreatePolicy(Fractures.class, [:], getSymbolSize()), new ResizePolicy(), new MovePolicy()])
	}
}