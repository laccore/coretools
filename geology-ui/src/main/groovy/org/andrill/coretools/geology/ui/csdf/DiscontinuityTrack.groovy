...
import org.andrill.coretools.geology.models.csdf.Discontinuity

class DiscontinuityTrack extends AbstractFeatureTrack implements FeedbackProvider {
	private static final String DEFAULT_TITLE = "Discontinuity"
	...
	def getFilter() { return { it instanceof Discontinuity } }
	List<Class> getCreatedClasses() { return [Discontinuity] }
	protected SceneEventHandler createHandler() { 
		new DefaultTrackEventHandler(this, [new CreatePolicy(Discontinuity.class, [:], -1, this), new ResizePolicy(), new MovePolicy()])
	}
